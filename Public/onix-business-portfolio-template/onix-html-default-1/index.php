...
<?php  include($_SERVER['DOCUMENT_ROOT'].'/partials/Menu.html'); ?>
...
<!-- Slider
================================================== -->
<?php  include($_SERVER['DOCUMENT_ROOT'].'/partials/slider.html'); ?>

    
    <div style="position:relative">
     <ul id="nav">
				<li><img src="assets/images/tn-model1.png" alt="Model 1" /></li>
				<li><img src="assets/images/tn-model2.png" alt="Model 2" /></li>
				<li><img src="assets/images/tn-model3.png" alt="Model 3" /></li>
                <li><img src="assets/images/tn-model4.png" alt="Model 4" /></li>
			</ul>
    </div>
...
<div class="row">
 ...
 <div class="span4 block-info">
  <h3><a href="#" class="home-title">Responsive Template</a></h3>
  <img src="assets/img/slider-img03.jpg" alt="" style="margin:25px 0 20px">
  <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore.</p>
  <a class="btn pull-right" href="#">read more</a>
 </div>
 
 <div class="span4 block-info">
  <h3><a href="#" class="home-title">Clean and Minimalis</a></h3>
  <img src="assets/img/slider-img02.jpg" alt="" style="margin:25px 0 20px">
  <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore.</p>
  <a class="btn pull-right" href="#">read more</a>
 </div>
 
 <div class="span4 block-info">
  <h3><a href="#" class="home-title">Video &amp; Audio Support</a></h3>
  <img src="assets/img/slider-img03.jpg" alt="" style="margin:25px 0 20px">
  <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore.</p>
  <a class="btn pull-right" href="#">read more</a>
 </div>
  ...
  <ul class="thumbnails">
   ...
   <li class="span3 item-block">
    ...
    <li class="span3 item-block">
     <div class="row">
      <div class="span3">
     <video src="assets/media/VH_videoAsset.flv" type="video/flv" controls></video>
     </div>
     </div>
      <div class="desc">
  ...
  <div class="row">
   ...
   <div class="span8">
    ...
    <div class="span4 block-info pull-left">
      <img class="pull-left" src="assets/img/create-icon.png" alt="">
      <h3><a href="#">web design</a></h3>
      <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore.</p>
    </div>
    <div class="span4 block-info pull-left">
      <img class="pull-left" src="assets/img/develop-icon.png" alt="">
      <h3><a href="#">development</a></h3>
      <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore.</p>
    </div>
    <div class="span4 block-info pull-left">
      <img class="pull-left" src="assets/img/usability-icon.png" alt="">
      <h3><a href="#">usability</a></h3>
      <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore.</p>
    </div>
    <div class="span4 block-info pull-left">
      <img class="pull-left" src="assets/img/responsive.png" alt="">
...
================================================== -->
    ...
    <div class="span3 blog-home">
     <img src="assets/img/blog-examples/blog-home.jpg" alt="">
...
================================================== -->
 ...
 <div class="row promo-buy">
  ...
  <div class="span3"><a class="btn btn-large btn-success right margin-right" href="#"><i class="icon-shopping-cart icon-white"></i> Buy This Template »</a></div>
 </div>
 </div>
  ...
  <div class="divider"></div>
    ...
    <script type="text/javascript" src="assets/js/sslider-min.js"></script>
	<script type="text/javascript">	
